        ...
        <div className="max-w-7xl mx-auto px-4 pt-2 pb-8 md:pt-4 md:pb-12 grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg">
                ...
                <p className="text-gray-700 mb-2">
                    <strong>Địa chỉ:</strong> Số nhà 14, Đường Phạm Ngũ Lão, Phường Ka Long, Thành phố Móng Cái, Tỉnh
                    Quảng Ninh, Việt Nam
                </p>
                <p className="text-gray-700 mb-2"><strong>Điện thoại: </strong>
                ...
                <p className="text-gray-700"><strong>Email:</strong> fibygroup@gmail.com</p>
            </div>
            <div className="bg-white p-6 rounded-lg">
