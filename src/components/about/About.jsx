...
export default function About() {
    return (
        <div className="max-w-7xl mx-auto space-y-10 pt-2 pb-8 md:pt-4 md:pb-12">
            <section className="text-center max-w-4xl mx-auto">
                <h1 className="text-3xl md:text-4xl font-bold ">Về Chúng Tôi</h1>
                ...
                <p className="text-gray-600">
                    Chúng tôi là công ty chuyên sản xuất và phân phối các sản phẩm tẩy rửa sinh hoạt như nước giặt, nước
                    rửa chén, nước lau sàn và nhiều sản phẩm khác phục vụ cuộc sống hàng ngày. Sứ mệnh của chúng tôi là
                    mang đến giải pháp làm sạch hiệu quả, an toàn và thân thiện với môi trường.
                </p>
            </section>
            <section className="grid bg-white rounded-lg p-4 md:grid-cols-2 gap-6 items-center">
                <div>
                    <h2 className="text-2xl font-semibold mb-4">Chúng tôi là ai?</h2>
                    <p className="text-gray-700 leading-relaxed">
                        Được thành lập từ năm 2020, chúng tôi đã xây dựng được thương hiệu uy tín trong lĩnh vực hóa
                        phẩm tiêu dùng. Với đội ngũ kỹ sư, chuyên gia hóa học giàu kinh nghiệm, chúng tôi luôn không
                        ngừng cải tiến công thức và chất lượng sản phẩm để đáp ứng nhu cầu ngày càng cao của người tiêu
                        dùng Việt.
                    </p>
                </div>
                <img
